function SupervisorManager()
{
    ...
    this.supervisorControl = function(event)
    {
        ...
        $.post('/en/supervisor/default/supervisor-control', {
    ...
    this.processControl = function(event)
    {
        ...
        $.post('/en/supervisor/default/process-control', {
    ...
    {
        var actionUrl = '/en/supervisor/default/group-control';

        if ($(event.currentTarget).hasClass('processConfigControl')) {
            actionUrl = '/en/supervisor/default/process-config-control';
        }
    ...
    this.groupProcessDelete = function(event)
    {
        ...
        $.post('/en/supervisor/default/count-group-processes', {
            groupName: groupName
        ...
        function call(actionType) {
            $.post('/en/supervisor/default/process-config-control', {
                actionType: actionType,
                groupName : groupName
            }, responseHandler);
        }
    ...
    this.showLog = function(event)
    {
        ...
        $.post('/en/supervisor/default/get-process-log', {
            processName: processName,
            logType: logType
        }, function(response) {
